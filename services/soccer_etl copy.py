...
def predicting_value(**kwargs):
    ...
    X = players[['Min', 'Starts', 'MP', 'CarPrgDist', 'CarTotDist', 'Rec' ,'Carries','SCA','TouAtt3rd','Shots','PPA']] 
    y = players['Value']
    ...
    joblib.dump(model, '/home/camilo/soccer/modelo.pkl')
    players_df = players.loc[y_test.index]
    print(players)
    regressor = joblib.load('/home/camilo/soccer/modelo.pkl')
    players_df['predicted_value'] =  regressor.predict(players_df[['Min', 'Starts', 'MP', 'CarPrgDist', 'CarTotDist', 'Rec' ,'Carries','SCA','TouAtt3rd','Shots','PPA']])
    

    players_df.to_csv('/home/camilo/soccer/data/resultadospred.csv')
